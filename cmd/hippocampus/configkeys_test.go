...
var unmanagedConfigKeys = map[string]string{
	...
	"consolidation.significanceLevels.unusedRetentionInDays": "how long the significance registry keeps a value nothing carries any more; defaulted and in force, and a window to widen once a client's use of SignificancePlacement is known rather than to guess at before there is one",
