...
type TopologyNodeKind int32

const (
	TopologyNodeKind_TOPOLOGY_NODE_KIND_UNSPECIFIED       TopologyNodeKind = 0  // not set
	TopologyNodeKind_TOPOLOGY_NODE_KIND_INSTANCE          TopologyNodeKind = 1  // a Hippocampus instance: this one, or a peer sharing its store
	TopologyNodeKind_TOPOLOGY_NODE_KIND_STORE             TopologyNodeKind = 2  // the primary store (SQLite file, PostgreSQL, MySQL)
	...
	TopologyNodeKind_TOPOLOGY_NODE_KIND_BRIDGE            TopologyNodeKind = 10 // an event-sourcing broker bridge
...
var (
	TopologyNodeKind_name = map[int32]string{
		0:  "TOPOLOGY_NODE_KIND_UNSPECIFIED",
		1:  "TOPOLOGY_NODE_KIND_INSTANCE",
		2:  "TOPOLOGY_NODE_KIND_STORE",
		3:  "TOPOLOGY_NODE_KIND_SEARCH_INDEX",
		4:  "TOPOLOGY_NODE_KIND_SUMMARISER",
		5:  "TOPOLOGY_NODE_KIND_EMBEDDER",
		6:  "TOPOLOGY_NODE_KIND_OBJECT_STORE",
		7:  "TOPOLOGY_NODE_KIND_TRANSFER_TARGET",
		8:  "TOPOLOGY_NODE_KIND_IDENTITY_PROVIDER",
		9:  "TOPOLOGY_NODE_KIND_COLLECTOR",
		10: "TOPOLOGY_NODE_KIND_BRIDGE",
	...
	TopologyNodeKind_value = map[string]int32{
		...
		"TOPOLOGY_NODE_KIND_INSTANCE":          1,
		"TOPOLOGY_NODE_KIND_STORE":             2,
		"TOPOLOGY_NODE_KIND_SEARCH_INDEX":      3,
		"TOPOLOGY_NODE_KIND_SUMMARISER":        4,
		"TOPOLOGY_NODE_KIND_EMBEDDER":          5,
		"TOPOLOGY_NODE_KIND_OBJECT_STORE":      6,
		"TOPOLOGY_NODE_KIND_TRANSFER_TARGET":   7,
		"TOPOLOGY_NODE_KIND_IDENTITY_PROVIDER": 8,
		"TOPOLOGY_NODE_KIND_COLLECTOR":         9,
		"TOPOLOGY_NODE_KIND_BRIDGE":            10,
...
func (x TopologyNodeKind) Enum() *TopologyNodeKind {
	p := new(TopologyNodeKind)
	*p = x
	return p
}

func (x TopologyNodeKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type TopologyNodeSource int32

const (
	TopologyNodeSource_TOPOLOGY_NODE_SOURCE_UNSPECIFIED TopologyNodeSource = 0 // not set
	TopologyNodeSource_TOPOLOGY_NODE_SOURCE_SELF        TopologyNodeSource = 1 // this process
	TopologyNodeSource_TOPOLOGY_NODE_SOURCE_CONFIGURED  TopologyNodeSource = 2 // something this instance dials, read from its own configuration
	TopologyNodeSource_TOPOLOGY_NODE_SOURCE_DISCOVERED  TopologyNodeSource = 3 // a peer instance found in the shared store
	TopologyNodeSource_TOPOLOGY_NODE_SOURCE_DECLARED    TopologyNodeSource = 4 // an operator listed it under topology.components
	TopologyNodeSource_TOPOLOGY_NODE_SOURCE_OBSERVED    TopologyNodeSource = 5 // it has called this instance with a verified token
)

// Enum value maps for TopologyNodeSource.
var (
	TopologyNodeSource_name = map[int32]string{
		0: "TOPOLOGY_NODE_SOURCE_UNSPECIFIED",
		1: "TOPOLOGY_NODE_SOURCE_SELF",
		2: "TOPOLOGY_NODE_SOURCE_CONFIGURED",
		3: "TOPOLOGY_NODE_SOURCE_DISCOVERED",
		4: "TOPOLOGY_NODE_SOURCE_DECLARED",
		5: "TOPOLOGY_NODE_SOURCE_OBSERVED",
	}
	TopologyNodeSource_value = map[string]int32{
		"TOPOLOGY_NODE_SOURCE_UNSPECIFIED": 0,
		"TOPOLOGY_NODE_SOURCE_SELF":        1,
		"TOPOLOGY_NODE_SOURCE_CONFIGURED":  2,
		"TOPOLOGY_NODE_SOURCE_DISCOVERED":  3,
		"TOPOLOGY_NODE_SOURCE_DECLARED":    4,
		"TOPOLOGY_NODE_SOURCE_OBSERVED":    5,
	}
)

func (x TopologyNodeSource) Enum() *TopologyNodeSource {
	p := new(TopologyNodeSource)
	*p = x
	return p
}

func (x TopologyNodeSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type TopologyStatus int32

const (
	TopologyStatus_TOPOLOGY_STATUS_UNSPECIFIED TopologyStatus = 0 // not probed; checked_at is 0
	TopologyStatus_TOPOLOGY_STATUS_OK          TopologyStatus = 1 // reachable and serving
	TopologyStatus_TOPOLOGY_STATUS_DEGRADED    TopologyStatus = 2 // reachable, but reporting a problem of its own; see status_detail
	TopologyStatus_TOPOLOGY_STATUS_UNREACHABLE TopologyStatus = 3 // the probe failed; see status_detail
	TopologyStatus_TOPOLOGY_STATUS_DISABLED    TopologyStatus = 4 // configured off, so nothing to probe
)

// Enum value maps for TopologyStatus.
var (
	TopologyStatus_name = map[int32]string{
		0: "TOPOLOGY_STATUS_UNSPECIFIED",
		1: "TOPOLOGY_STATUS_OK",
		2: "TOPOLOGY_STATUS_DEGRADED",
		3: "TOPOLOGY_STATUS_UNREACHABLE",
		4: "TOPOLOGY_STATUS_DISABLED",
	}
	TopologyStatus_value = map[string]int32{
		"TOPOLOGY_STATUS_UNSPECIFIED": 0,
		"TOPOLOGY_STATUS_OK":          1,
		"TOPOLOGY_STATUS_DEGRADED":    2,
		"TOPOLOGY_STATUS_UNREACHABLE": 3,
		"TOPOLOGY_STATUS_DISABLED":    4,
	}
)

func (x TopologyStatus) Enum() *TopologyStatus {
	p := new(TopologyStatus)
	*p = x
	return p
}
...
type GetSignificanceLevelsRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	SignificanceMin int32                  `protobuf:"varint,1,opt,name=significance_min,json=significanceMin,proto3" json:"significance_min,omitempty"` // inclusive lower bound; 0 (the default) means no lower bound, NOT a literal significance-of-zero filter
	SignificanceMax int32                  `protobuf:"varint,2,opt,name=significance_max,json=significanceMax,proto3" json:"significance_max,omitempty"` // inclusive upper bound; 0 (the default) means no upper bound
	Limit           int32                  `protobuf:"varint,3,opt,name=limit,proto3" json:"limit,omitempty"`                                            // page size; a value <= 0 selects the server default (200); values above the server cap (1000) are silently clamped down to it
	Offset          int32                  `protobuf:"varint,4,opt,name=offset,proto3" json:"offset,omitempty"`                                          // rows to skip for pagination; negative values are clamped to 0; no upper bound
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *GetSignificanceLevelsRequest) Reset() {
	*x = GetSignificanceLevelsRequest{}
	mi := &file_hippocampus_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSignificanceLevelsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSignificanceLevelsRequest) ProtoMessage() {}

func (x *GetSignificanceLevelsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_hippocampus_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSignificanceLevelsRequest.ProtoReflect.Descriptor instead.
func (*GetSignificanceLevelsRequest) Descriptor() ([]byte, []int) {
	return file_hippocampus_proto_rawDescGZIP(), []int{1}
}

func (x *GetSignificanceLevelsRequest) GetSignificanceMin() int32 {
	if x != nil {
...
func (x *GetSignificanceLevelsRequest) GetSignificanceMax() int32 {
	if x != nil {
...
func (x *GetSignificanceLevelsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GetSignificanceLevelsRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type GetSignificanceLevelsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Significances []int32                `protobuf:"varint,1,rep,packed,name=significances,proto3" json:"significances,omitempty"`      // the distinct significance values in use, ascending. Two ADJACENT values have no room between them - that is what SignificancePlacement exists to open, and what makes this list the set of anchors a placement can name
	TotalCount    int32                  `protobuf:"varint,2,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"` // values matching the bounds, ignoring limit/offset - for pagination
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetSignificanceLevelsResponse) Reset() {
	*x = GetSignificanceLevelsResponse{}
	mi := &file_hippocampus_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetSignificanceLevelsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSignificanceLevelsResponse) ProtoMessage() {}

func (x *GetSignificanceLevelsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_hippocampus_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSignificanceLevelsResponse.ProtoReflect.Descriptor instead.
func (*GetSignificanceLevelsResponse) Descriptor() ([]byte, []int) {
	return file_hippocampus_proto_rawDescGZIP(), []int{2}
}

func (x *GetSignificanceLevelsResponse) GetSignificances() []int32 {
	if x != nil {
		return x.Significances
	}
	return nil
}

func (x *GetSignificanceLevelsResponse) GetTotalCount() int32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
type GetEventByIdRequest struct {
	...
	Links         bool                   `protobuf:"varint,4,opt,name=links,proto3" json:"links,omitempty"`                                   // true also loads the event's outbound links into the response (see Event.links); GetEventLinks reads both directions
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetEventByIdRequest) GetLinks() bool {
	if x != nil {
		return x.Links
	}
	return false
...
type GetEventsRequest struct {
	...
	Ended                Bool                   `protobuf:"varint,16,opt,name=ended,proto3,enum=hippocampus.v1.Bool" json:"ended,omitempty"`                                                                           // optional: FALSE returns only events that have not ended (time_end = 0), TRUE only those that have; UNSPECIFIED (default) applies no restriction. This is what answers "what is still running?" - time_end_min cannot, because 0 there means no bound. The events' counterpart to GetMemoriesRequest.recalled, and there for the same reason
...
func (x *GetEventsRequest) GetEnded() Bool {
	if x != nil {
		return x.Ended
	}
	return Bool_UNSPECIFIED
...
func (x *GetEventsRequest) GetNameContains() string {
	if x != nil {
...
func (x *GetEventsRequest) GetLinks() bool {
	if x != nil {
		return x.Links
	}
	return false
...
type StoreMemoriesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Memories      []*Memory              `protobuf:"bytes,1,rep,name=memories,proto3" json:"memories,omitempty"` // at most 500; a larger batch is refused with INVALID_ARGUMENT rather than truncated
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StoreMemoriesRequest) Reset() {
	*x = StoreMemoriesRequest{}
	mi := &file_hippocampus_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StoreMemoriesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreMemoriesRequest) ProtoMessage() {}

func (x *StoreMemoriesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_hippocampus_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreMemoriesRequest.ProtoReflect.Descriptor instead.
func (*StoreMemoriesRequest) Descriptor() ([]byte, []int) {
	return file_hippocampus_proto_rawDescGZIP(), []int{18}
}

func (x *StoreMemoriesRequest) GetMemories() []*Memory {
	if x != nil {
		return x.Memories
	}
	return nil
...
type StoreMemoryResult struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`              // the stored memory's id; empty when the memory was rejected or failed
	Rejected      bool                   `protobuf:"varint,2,opt,name=rejected,proto3" json:"rejected,omitempty"` // true when the memory was dropped for significance below memory.minimumSignificance - not an error, exactly as on StoreMemoryResponse
	Code          int32                  `protobuf:"varint,3,opt,name=code,proto3" json:"code,omitempty"`         // the gRPC status code this memory failed with (google.rpc.Code; 0 = OK), so a producer can tell a permanent rejection from a retryable one without parsing error
	Error         string                 `protobuf:"bytes,4,opt,name=error,proto3" json:"error,omitempty"`        // the failure message; empty unless code is non-zero
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StoreMemoryResult) Reset() {
	*x = StoreMemoryResult{}
...
func (x *StoreMemoryResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreMemoryResult) ProtoMessage() {}

func (x *StoreMemoryResult) ProtoReflect() protoreflect.Message {
	mi := &file_hippocampus_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreMemoryResult.ProtoReflect.Descriptor instead.
func (*StoreMemoryResult) Descriptor() ([]byte, []int) {
	return file_hippocampus_proto_rawDescGZIP(), []int{19}
}

func (x *StoreMemoryResult) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *StoreMemoryResult) GetRejected() bool {
	if x != nil {
		return x.Rejected
	}
	return false
...
func (x *StoreMemoryResult) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *StoreMemoryResult) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *StoreMemoriesResponse) Reset() {
	*x = StoreMemoriesResponse{}
	mi := &file_hippocampus_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StoreMemoriesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreMemoriesResponse) ProtoMessage() {}

func (x *StoreMemoriesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_hippocampus_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreMemoriesResponse.ProtoReflect.Descriptor instead.
func (*StoreMemoriesResponse) Descriptor() ([]byte, []int) {
	return file_hippocampus_proto_rawDescGZIP(), []int{20}
}

func (x *StoreMemoriesResponse) GetResults() []*StoreMemoryResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *StoreMemoriesResponse) GetStored() int32 {
	if x != nil {
		return x.Stored
	}
	return 0
...
func (x *StoreMemoriesResponse) GetRejected() int32 {
	if x != nil {
		return x.Rejected
	}
	return 0
...
func (x *StoreMemoriesResponse) GetFailed() int32 {
	if x != nil {
		return x.Failed
	}
	return 0
...
type DeleteMemoriesByFilterRequest struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	TimestampMin         int64                  `protobuf:"varint,1,opt,name=timestamp_min,json=timestampMin,proto3" json:"timestamp_min,omitempty"`                                                                  // UnixNano inclusive lower bound on time_stamp; 0 (the default) means no lower bound
	TimestampMax         int64                  `protobuf:"varint,2,opt,name=timestamp_max,json=timestampMax,proto3" json:"timestamp_max,omitempty"`                                                                  // UnixNano inclusive upper bound on time_stamp; 0 (the default) means no upper bound
	SignificanceMin      int32                  `protobuf:"varint,3,opt,name=significance_min,json=significanceMin,proto3" json:"significance_min,omitempty"`                                                         // inclusive lower bound on significance; 0 (the default) means no bound, NOT a literal significance-of-zero filter
	SignificanceMax      int32                  `protobuf:"varint,4,opt,name=significance_max,json=significanceMax,proto3" json:"significance_max,omitempty"`                                                         // inclusive upper bound on significance; 0 (the default) means no bound, NOT a literal significance-of-zero filter
	Group                string                 `protobuf:"bytes,5,opt,name=group,proto3" json:"group,omitempty"`                                                                                                     // restrict to memories carrying this group label - the field that makes offboarding a group one call
	SignificanceExtremum SignificanceExtremum   `protobuf:"varint,6,opt,name=significance_extremum,json=significanceExtremum,proto3,enum=hippocampus.v1.SignificanceExtremum" json:"significance_extremum,omitempty"` // when set, ignore significance_min/significance_max and delete only the memories tied at that significance value among the other filters; 0 (default) applies no extremum
	Metadata             []string               `protobuf:"bytes,7,rep,name=metadata,proto3" json:"metadata,omitempty"`                                                                                               // restrict to memories whose metadata carries every one of these "key=value" pairs (AND, exact match), exactly as GetMemoriesRequest.metadata
	Recalled             Bool                   `protobuf:"varint,8,opt,name=recalled,proto3,enum=hippocampus.v1.Bool" json:"recalled,omitempty"`                                                                     // FALSE selects only never-recalled memories, TRUE only those recalled at least once; UNSPECIFIED (default) applies no restriction
	RecallCountMin       int32                  `protobuf:"varint,9,opt,name=recall_count_min,json=recallCountMin,proto3" json:"recall_count_min,omitempty"`                                                          // inclusive lower bound on recall_count; 0 (the default) means no bound
	RecallCountMax       int32                  `protobuf:"varint,10,opt,name=recall_count_max,json=recallCountMax,proto3" json:"recall_count_max,omitempty"`                                                         // inclusive upper bound on recall_count; 0 (the default) means no bound
	TimeRecalledMin      int64                  `protobuf:"varint,11,opt,name=time_recalled_min,json=timeRecalledMin,proto3" json:"time_recalled_min,omitempty"`                                                      // UnixNano inclusive lower bound on time_recalled; 0 means no bound. Like GetMemoriesRequest's, both bounds ask only about memories that HAVE been recalled
	TimeRecalledMax      int64                  `protobuf:"varint,12,opt,name=time_recalled_max,json=timeRecalledMax,proto3" json:"time_recalled_max,omitempty"`                                                      // UnixNano inclusive upper bound on time_recalled; 0 means no bound. Never-recalled memories are excluded rather than matched - use recalled for those
	IsSummary            Bool                   `protobuf:"varint,13,opt,name=is_summary,json=isSummary,proto3,enum=hippocampus.v1.Bool" json:"is_summary,omitempty"`                                                 // TRUE selects only summary memories, FALSE only non-summaries; UNSPECIFIED (default) applies no restriction
	IsBinary             Bool                   `protobuf:"varint,14,opt,name=is_binary,json=isBinary,proto3,enum=hippocampus.v1.Bool" json:"is_binary,omitempty"`                                                    // TRUE selects only binary memories, FALSE only non-binary; UNSPECIFIED (default) applies no restriction
	EventId              string                 `protobuf:"bytes,15,opt,name=event_id,json=eventId,proto3" json:"event_id,omitempty"`                                                                                 // restrict to one event's memories. Empty (the default) applies no restriction rather than matching the event-less; use has_event for those
	HasEvent             Bool                   `protobuf:"varint,16,opt,name=has_event,json=hasEvent,proto3,enum=hippocampus.v1.Bool" json:"has_event,omitempty"`                                                    // FALSE selects only memories associated with no event, TRUE only those associated with one; UNSPECIFIED (default) applies no restriction
	MaxDeletions         int64                  `protobuf:"varint,17,opt,name=max_deletions,json=maxDeletions,proto3" json:"max_deletions,omitempty"`                                                                 // stop after deleting this many memories; 0 (the default) means no bound, so the call runs until the filter matches nothing. complete on the response reports which happened
	DeleteEmptyEvents    bool                   `protobuf:"varint,18,opt,name=delete_empty_events,json=deleteEmptyEvents,proto3" json:"delete_empty_events,omitempty"`                                                // also delete each event that the deletion left with no memories at all, exactly as Clear does. An event that still holds a memory is never touched
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *DeleteMemoriesByFilterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteMemoriesByFilterRequest) GetTimestampMax() int64 {
	if x != nil {
		return x.TimestampMax
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetSignificanceMin() int32 {
	if x != nil {
		return x.SignificanceMin
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetSignificanceMax() int32 {
	if x != nil {
		return x.SignificanceMax
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
func (x *DeleteMemoriesByFilterRequest) GetSignificanceExtremum() SignificanceExtremum {
	if x != nil {
		return x.SignificanceExtremum
	}
	return SignificanceExtremum_SIGNIFICANCE_EXTREMUM_UNSPECIFIED
...
func (x *DeleteMemoriesByFilterRequest) GetMetadata() []string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *DeleteMemoriesByFilterRequest) GetRecalled() Bool {
	if x != nil {
		return x.Recalled
	}
	return Bool_UNSPECIFIED
...
func (x *DeleteMemoriesByFilterRequest) GetRecallCountMin() int32 {
	if x != nil {
		return x.RecallCountMin
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetRecallCountMax() int32 {
	if x != nil {
		return x.RecallCountMax
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetTimeRecalledMin() int64 {
	if x != nil {
		return x.TimeRecalledMin
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetTimeRecalledMax() int64 {
	if x != nil {
		return x.TimeRecalledMax
	}
	return 0
...
func (x *DeleteMemoriesByFilterRequest) GetIsSummary() Bool {
	if x != nil {
		return x.IsSummary
	}
	return Bool_UNSPECIFIED
...
func (x *DeleteMemoriesByFilterRequest) GetIsBinary() Bool {
	if x != nil {
		return x.IsBinary
	}
	return Bool_UNSPECIFIED
...
func (x *DeleteMemoriesByFilterRequest) GetEventId() string {
	if x != nil {
		return x.EventId
	}
	return ""
...
func (x *DeleteMemoriesByFilterRequest) GetHasEvent() Bool {
	if x != nil {
		return x.HasEvent
	}
	return Bool_UNSPECIFIED
...
func (x *DeleteMemoriesByFilterRequest) GetMaxDeletions() int64 {
	if x != nil {
...
func (x *DeleteMemoriesByFilterRequest) GetDeleteEmptyEvents() bool {
	if x != nil {
		return x.DeleteEmptyEvents
	}
	return false
}
...
func (x *DeleteMemoriesByFilterResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteMemoriesByFilterResponse) GetEventsDeleted() int64 {
	if x != nil {
...
func (x *DeleteMemoriesByFilterResponse) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
// refused.
type DeleteEventsByFilterRequest struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	TimeStartMin         int64                  `protobuf:"varint,1,opt,name=time_start_min,json=timeStartMin,proto3" json:"time_start_min,omitempty"`                                                                // UnixNano inclusive lower bound on time_start; 0 (the default) means no lower bound
	TimeStartMax         int64                  `protobuf:"varint,2,opt,name=time_start_max,json=timeStartMax,proto3" json:"time_start_max,omitempty"`                                                                // UnixNano inclusive upper bound on time_start; 0 (the default) means no upper bound
	TimeEndMin           int64                  `protobuf:"varint,3,opt,name=time_end_min,json=timeEndMin,proto3" json:"time_end_min,omitempty"`                                                                      // UnixNano inclusive lower bound on time_end; 0 (the default) means no lower bound
	TimeEndMax           int64                  `protobuf:"varint,4,opt,name=time_end_max,json=timeEndMax,proto3" json:"time_end_max,omitempty"`                                                                      // UnixNano inclusive upper bound on time_end; 0 (the default) means no upper bound. Open events store time_end = 0 and are excluded rather than matched - use ended for those
	SignificanceMin      int32                  `protobuf:"varint,5,opt,name=significance_min,json=significanceMin,proto3" json:"significance_min,omitempty"`                                                         // inclusive lower bound on significance; 0 (the default) means no bound
	SignificanceMax      int32                  `protobuf:"varint,6,opt,name=significance_max,json=significanceMax,proto3" json:"significance_max,omitempty"`                                                         // inclusive upper bound on significance; 0 (the default) means no bound
	Group                string                 `protobuf:"bytes,7,opt,name=group,proto3" json:"group,omitempty"`                                                                                                     // restrict to events carrying this group label
	SignificanceExtremum SignificanceExtremum   `protobuf:"varint,8,opt,name=significance_extremum,json=significanceExtremum,proto3,enum=hippocampus.v1.SignificanceExtremum" json:"significance_extremum,omitempty"` // when set, ignore significance_min/significance_max and delete only the events tied at that significance value among the other filters
	Metadata             []string               `protobuf:"bytes,9,rep,name=metadata,proto3" json:"metadata,omitempty"`                                                                                               // restrict to events whose metadata carries every one of these "key=value" pairs (AND, exact match)
...
func (x *DeleteEventsByFilterRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteEventsByFilterRequest) GetTimeStartMax() int64 {
	if x != nil {
		return x.TimeStartMax
	}
	return 0
...
func (x *DeleteEventsByFilterRequest) GetTimeEndMin() int64 {
	if x != nil {
		return x.TimeEndMin
	}
	return 0
...
func (x *DeleteEventsByFilterRequest) GetTimeEndMax() int64 {
	if x != nil {
		return x.TimeEndMax
	}
	return 0
...
func (x *DeleteEventsByFilterRequest) GetSignificanceMin() int32 {
	if x != nil {
		return x.SignificanceMin
	}
	return 0
...
func (x *DeleteEventsByFilterRequest) GetSignificanceMax() int32 {
	if x != nil {
		return x.SignificanceMax
	}
	return 0
...
func (x *DeleteEventsByFilterRequest) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
func (x *DeleteEventsByFilterRequest) GetSignificanceExtremum() SignificanceExtremum {
	if x != nil {
		return x.SignificanceExtremum
	}
	return SignificanceExtremum_SIGNIFICANCE_EXTREMUM_UNSPECIFIED
...
func (x *DeleteEventsByFilterRequest) GetMetadata() []string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *DeleteEventsByFilterRequest) GetEnded() Bool {
	if x != nil {
		return x.Ended
	}
	return Bool_UNSPECIFIED
...
func (x *DeleteEventsByFilterRequest) GetNameContains() string {
	if x != nil {
		return x.NameContains
	}
	return ""
...
func (x *DeleteEventsByFilterRequest) GetMaxDeletions() int64 {
	if x != nil {
		return x.MaxDeletions
	}
	return 0
...
func (x *DeleteEventsByFilterResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DeleteEventsByFilterResponse) GetMemoriesDeleted() int64 {
	if x != nil {
		return x.MemoriesDeleted
	}
	return 0
...
func (x *DeleteEventsByFilterResponse) GetMemoriesOrphaned() int64 {
	if x != nil {
		return x.MemoriesOrphaned
	}
	return 0
}

func (x *DeleteEventsByFilterResponse) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
type GetConsolidationStatusResponse struct {
	...
	// console polls.
	Ancillary     *AncillaryStorage `protobuf:"bytes,8,opt,name=ancillary,proto3" json:"ancillary,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConsolidationStatusResponse) GetAncillary() *AncillaryStorage {
	if x != nil {
		return x.Ancillary
	}
	return nil
...
func (x *AncillaryTable) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AncillaryTable) GetRows() int64 {
	if x != nil {
		return x.Rows
	}
	return 0
...
func (x *AncillaryTable) GetBytes() int64 {
	if x != nil {
		return x.Bytes
	}
	return 0
...
func (x *AncillaryStorage) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AncillaryStorage) GetTotalBytes() int64 {
	if x != nil {
		return x.TotalBytes
	}
	return 0
...
func (x *AncillaryStorage) GetForgottenLog() *AncillaryTable {
	if x != nil {
		return x.ForgottenLog
	}
	return nil
}

func (x *AncillaryStorage) GetSearchOutbox() *AncillaryTable {
	if x != nil {
		return x.SearchOutbox
	}
	return nil
}

func (x *AncillaryStorage) GetCallbackQueue() *AncillaryTable {
	if x != nil {
...
type WhoAmIResponse struct {
	...
	// certain to fail.
	TopologyTier string `protobuf:"bytes,10,opt,name=topology_tier,json=topologyTier,proto3" json:"topology_tier,omitempty"`
	...
	CallbacksEnabled bool `protobuf:"varint,12,opt,name=callbacks_enabled,json=callbacksEnabled,proto3" json:"callbacks_enabled,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *WhoAmIResponse) GetTopologyTier() string {
	if x != nil {
		return x.TopologyTier
	}
	return ""
}
...
func (x *WhoAmIResponse) GetCallbacksEnabled() bool {
	if x != nil {
		return x.CallbacksEnabled
	}
	return false
}
...
func (x *TopologyAttribute) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TopologyAttribute) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *TopologyNode) GetKind() TopologyNodeKind {
	if x != nil {
		return x.Kind
	}
	return TopologyNodeKind_TOPOLOGY_NODE_KIND_UNSPECIFIED
}
...
func (x *TopologyNode) GetDetail() string {
	if x != nil {
		return x.Detail
	}
	return ""
...
func (x *TopologyNode) GetSource() TopologyNodeSource {
	if x != nil {
		return x.Source
	}
	return TopologyNodeSource_TOPOLOGY_NODE_SOURCE_UNSPECIFIED
}

func (x *TopologyNode) GetStatus() TopologyStatus {
	if x != nil {
		return x.Status
	}
	return TopologyStatus_TOPOLOGY_STATUS_UNSPECIFIED
}

func (x *TopologyNode) GetStatusDetail() string {
	if x != nil {
...
func (x *TopologyNode) GetCheckedAt() int64 {
	if x != nil {
		return x.CheckedAt
	}
	return 0
...
func (x *TopologyNode) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *TopologyNode) GetAttributes() []*TopologyAttribute {
	if x != nil {
		return x.Attributes
	}
	return nil
...
func (x *TopologyEdge) GetToId() string {
	if x != nil {
		return x.ToId
	}
	return ""
...
func (x *TopologyEdge) GetOptional() bool {
	if x != nil {
		return x.Optional
	}
	return false
...
func (x *GetTopologyResponse) GetProbeIntervalSeconds() int64 {
	if x != nil {
...
func (x *GetTopologyResponse) GetGeneratedAt() int64 {
	if x != nil {
...
const file_hippocampus_proto_rawDesc = "" +
	...
	"\aBETWEEN\x10\x03\"\xa2\x01\n" +
	"\x1cGetSignificanceLevelsRequest\x12)\n" +
	"\x10significance_min\x18\x01 \x01(\x05R\x0fsignificanceMin\x12)\n" +
	"\x10significance_max\x18\x02 \x01(\x05R\x0fsignificanceMax\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x05R\x05limit\x12\x16\n" +
	"\x06offset\x18\x04 \x01(\x05R\x06offset\"f\n" +
	"\x1dGetSignificanceLevelsResponse\x12$\n" +
	"\rsignificances\x18\x01 \x03(\x05R\rsignificances\x12\x1f\n" +
	...
	"\torder_dir\x18\x0f \x01(\x0e2\x1d.hippocampus.v1.SortDirectionR\borderDir\x12*\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\brejected\x18\x02 \x01(\bR\brejected\"J\n" +
	"\x14StoreMemoriesRequest\x122\n" +
	"\bmemories\x18\x01 \x03(\v2\x16.hippocampus.v1.MemoryR\bmemories\"i\n" +
	"\x11StoreMemoryResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\brejected\x18\x02 \x01(\bR\brejected\x12\x12\n" +
	"\x04code\x18\x03 \x01(\x05R\x04code\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\"\xa0\x01\n" +
	"\x15StoreMemoriesResponse\x12;\n" +
	"\aresults\x18\x01 \x03(\v2!.hippocampus.v1.StoreMemoryResultR\aresults\x12\x16\n" +
	"\x06stored\x18\x02 \x01(\x05R\x06stored\x12\x1a\n" +
	"\brejected\x18\x03 \x01(\x05R\brejected\x12\x16\n" +
	...
	"\x0eevents_cleared\x18\x02 \x01(\x05R\reventsCleared\"\xb5\x06\n" +
	"\x1dDeleteMemoriesByFilterRequest\x12#\n" +
	"\rtimestamp_min\x18\x01 \x01(\x03R\ftimestampMin\x12#\n" +
	"\rtimestamp_max\x18\x02 \x01(\x03R\ftimestampMax\x12)\n" +
	"\x10significance_min\x18\x03 \x01(\x05R\x0fsignificanceMin\x12)\n" +
	"\x10significance_max\x18\x04 \x01(\x05R\x0fsignificanceMax\x12\x14\n" +
	...
	"\thas_event\x18\x10 \x01(\x0e2\x14.hippocampus.v1.BoolR\bhasEvent\x12#\n" +
	"\rmax_deletions\x18\x11 \x01(\x03R\fmaxDeletions\x12.\n" +
	"\x13delete_empty_events\x18\x12 \x01(\bR\x11deleteEmptyEvents\"\x8e\x01\n" +
	...
	"timeEndMax\x12)\n" +
	"\x10significance_min\x18\x05 \x01(\x05R\x0fsignificanceMin\x12)\n" +
	"\x10significance_max\x18\x06 \x01(\x05R\x0fsignificanceMax\x12\x14\n" +
	"\x05group\x18\a \x01(\tR\x05group\x12Y\n" +
	"\x15significance_extremum\x18\b \x01(\x0e2$.hippocampus.v1.SignificanceExtremumR\x14significanceExtremum\x12\x1a\n" +
	"\bmetadata\x18\t \x03(\tR\bmetadata\x12*\n" +
	"\x05ended\x18\n" +
	...
	"\x10memories_deleted\x18\x02 \x01(\x03R\x0fmemoriesDeleted\x12+\n" +
	"\x11memories_orphaned\x18\x03 \x01(\x03R\x10memoriesOrphaned\x12\x1a\n" +
	"\bcomplete\x18\x04 \x01(\bR\bcomplete\"!\n" +
	...
	"totalBytes\x12C\n" +
	"\rforgotten_log\x18\x03 \x01(\v2\x1e.hippocampus.v1.AncillaryTableR\fforgottenLog\x12C\n" +
	"\rsearch_outbox\x18\x04 \x01(\v2\x1e.hippocampus.v1.AncillaryTableR\fsearchOutbox\x12E\n" +
	"\x0ecallback_queue\x18\x05 \x01(\v2\x1e.hippocampus.v1.AncillaryTableR\rcallbackQueue\"\xdd\x03\n" +
	...
	"\x12tombstones_enabled\x18\t \x01(\bR\x11tombstonesEnabled\x12#\n" +
	"\rtopology_tier\x18\n" +
	" \x01(\tR\ftopologyTier\x12\x18\n" +
	"\aversion\x18\v \x01(\tR\aversion\x12+\n" +
	"\x11callbacks_enabled\x18\f \x01(\bR\x10callbacksEnabled\";\n" +
	"\x11TopologyAttribute\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\x95\x03\n" +
	"\fTopologyNode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x124\n" +
	"\x04kind\x18\x02 \x01(\x0e2 .hippocampus.v1.TopologyNodeKindR\x04kind\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x16\n" +
	"\x06detail\x18\x04 \x01(\tR\x06detail\x12:\n" +
	"\x06source\x18\x05 \x01(\x0e2\".hippocampus.v1.TopologyNodeSourceR\x06source\x126\n" +
	"\x06status\x18\x06 \x01(\x0e2\x1e.hippocampus.v1.TopologyStatusR\x06status\x12#\n" +
	"\rstatus_detail\x18\a \x01(\tR\fstatusDetail\x12\x1d\n" +
	"\n" +
	"checked_at\x18\b \x01(\x03R\tcheckedAt\x12\x18\n" +
	"\aversion\x18\t \x01(\tR\aversion\x12A\n" +
	"\n" +
	"attributes\x18\n" +
	" \x03(\v2!.hippocampus.v1.TopologyAttributeR\n" +
	"attributes\"n\n" +
	...
	"\x18TOPOLOGY_NODE_KIND_STORE\x10\x02\x12#\n" +
	"\x1fTOPOLOGY_NODE_KIND_SEARCH_INDEX\x10\x03\x12!\n" +
	"\x1dTOPOLOGY_NODE_KIND_SUMMARISER\x10\x04\x12\x1f\n" +
	"\x1bTOPOLOGY_NODE_KIND_EMBEDDER\x10\x05\x12#\n" +
	"\x1fTOPOLOGY_NODE_KIND_OBJECT_STORE\x10\x06\x12&\n" +
	"\"TOPOLOGY_NODE_KIND_TRANSFER_TARGET\x10\a\x12(\n" +
	"$TOPOLOGY_NODE_KIND_IDENTITY_PROVIDER\x10\b\x12 \n" +
	"\x1cTOPOLOGY_NODE_KIND_COLLECTOR\x10\t\x12\x1d\n" +
	"\x19TOPOLOGY_NODE_KIND_BRIDGE\x10\n" +
	"\x12\x1f\n" +
	...
	"\x1fTOPOLOGY_NODE_SOURCE_CONFIGURED\x10\x02\x12#\n" +
	"\x1fTOPOLOGY_NODE_SOURCE_DISCOVERED\x10\x03\x12!\n" +
	"\x1dTOPOLOGY_NODE_SOURCE_DECLARED\x10\x04\x12!\n" +
	"\x1dTOPOLOGY_NODE_SOURCE_OBSERVED\x10\x05*\xa6\x01\n" +
	"\x0eTopologyStatus\x12\x1f\n" +
	"\x1bTOPOLOGY_STATUS_UNSPECIFIED\x10\x00\x12\x16\n" +
	...
	"\x18TOPOLOGY_STATUS_DISABLED\x10\x042\xd7)\n" +
	"\vHippocampus\x12Y\n" +
	...
	"/v1/whoami\x12f\n" +
	"\vGetTopology\x12\x1c.hippocampus.v1.EmptyRequest\x1a#.hippocampus.v1.GetTopologyResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/topology\x12\x95\x01\n" +
	"\x15GetSignificanceLevels\x12,.hippocampus.v1.GetSignificanceLevelsRequest\x1a-.hippocampus.v1.GetSignificanceLevelsResponse\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/v1/significance/levels\x12^\n" +
	"\n" +
	"StoreEvent\x12\x15.hippocampus.v1.Event\x1a\".hippocampus.v1.StoreEventResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/events\x12a\n" +
	"\vUpdateEvent\x12\x15.hippocampus.v1.Event\x1a\x1f.hippocampus.v1.GeneralResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/events/{id}\x12l\n" +
	...
	"/v1/events\x12c\n" +
	"\vStoreMemory\x12\x16.hippocampus.v1.Memory\x1a#.hippocampus.v1.StoreMemoryResponse\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/memories\x12{\n" +
	"\rStoreMemories\x12$.hippocampus.v1.StoreMemoriesRequest\x1a%.hippocampus.v1.StoreMemoriesResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/memories/batch\x12e\n" +
	...
	"\x05Clear\x12\x1c.hippocampus.v1.ClearRequest\x1a\x1d.hippocampus.v1.ClearResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/clear\x12\xa1\x01\n" +
	"\x16DeleteMemoriesByFilter\x12-.hippocampus.v1.DeleteMemoriesByFilterRequest\x1a..hippocampus.v1.DeleteMemoriesByFilterResponse\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/memories/delete-by-filter\x12\x99\x01\n" +
	"\x14DeleteEventsByFilter\x12+.hippocampus.v1.DeleteEventsByFilterRequest\x1a,.hippocampus.v1.DeleteEventsByFilterResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/events/delete-by-filterB\xa8\x01\x92AoZ[\n" +
	"Y\n" +
	"\n" +
...
var file_hippocampus_proto_msgTypes = make([]protoimpl.MessageInfo, 86)
var file_hippocampus_proto_goTypes = []any{
	...
	(*GetSignificanceLevelsRequest)(nil),       // 13: hippocampus.v1.GetSignificanceLevelsRequest
	(*GetSignificanceLevelsResponse)(nil),      // 14: hippocampus.v1.GetSignificanceLevelsResponse
	(*Event)(nil),                              // 15: hippocampus.v1.Event
	(*Link)(nil),                               // 16: hippocampus.v1.Link
	(*Memory)(nil),                             // 17: hippocampus.v1.Memory
	(*StoreEventResponse)(nil),                 // 18: hippocampus.v1.StoreEventResponse
	(*EndEventRequest)(nil),                    // 19: hippocampus.v1.EndEventRequest
	(*UpdateEventSignificanceRequest)(nil),     // 20: hippocampus.v1.UpdateEventSignificanceRequest
	(*MergeEventsRequest)(nil),                 // 21: hippocampus.v1.MergeEventsRequest
	(*DeleteEventRequest)(nil),                 // 22: hippocampus.v1.DeleteEventRequest
	(*GetEventByIdRequest)(nil),                // 23: hippocampus.v1.GetEventByIdRequest
	(*GetEventResponse)(nil),                   // 24: hippocampus.v1.GetEventResponse
	(*GetEventsRequest)(nil),                   // 25: hippocampus.v1.GetEventsRequest
	(*GetEventsResponse)(nil),                  // 26: hippocampus.v1.GetEventsResponse
	(*GetMemoriesRequest)(nil),                 // 27: hippocampus.v1.GetMemoriesRequest
	(*GetMemoriesResponse)(nil),                // 28: hippocampus.v1.GetMemoriesResponse
	(*StoreMemoryResponse)(nil),                // 29: hippocampus.v1.StoreMemoryResponse
	(*StoreMemoriesRequest)(nil),               // 30: hippocampus.v1.StoreMemoriesRequest
	(*StoreMemoryResult)(nil),                  // 31: hippocampus.v1.StoreMemoryResult
	(*StoreMemoriesResponse)(nil),              // 32: hippocampus.v1.StoreMemoriesResponse
	(*DeleteMemoriesRequest)(nil),              // 33: hippocampus.v1.DeleteMemoriesRequest
	(*RecallMemoriesRequest)(nil),              // 34: hippocampus.v1.RecallMemoriesRequest
	(*SearchMemoriesRequest)(nil),              // 35: hippocampus.v1.SearchMemoriesRequest
	(*LinkMemoriesRequest)(nil),                // 36: hippocampus.v1.LinkMemoriesRequest
	(*UnlinkMemoriesRequest)(nil),              // 37: hippocampus.v1.UnlinkMemoriesRequest
	(*GetMemoryLinksRequest)(nil),              // 38: hippocampus.v1.GetMemoryLinksRequest
	(*LinkEventsRequest)(nil),                  // 39: hippocampus.v1.LinkEventsRequest
	(*UnlinkEventsRequest)(nil),                // 40: hippocampus.v1.UnlinkEventsRequest
	(*GetEventLinksRequest)(nil),               // 41: hippocampus.v1.GetEventLinksRequest
	(*LinkEdge)(nil),                           // 42: hippocampus.v1.LinkEdge
	(*GetLinksResponse)(nil),                   // 43: hippocampus.v1.GetLinksResponse
	(*ReplaceMemoriesWithSummaryRequest)(nil),  // 44: hippocampus.v1.ReplaceMemoriesWithSummaryRequest
	(*ReplaceMemoriesWithSummaryResponse)(nil), // 45: hippocampus.v1.ReplaceMemoriesWithSummaryResponse
	(*SummarisationCandidate)(nil),             // 46: hippocampus.v1.SummarisationCandidate
	(*GetSummarisationCandidatesResponse)(nil), // 47: hippocampus.v1.GetSummarisationCandidatesResponse
	(*SummariseMemoriesRequest)(nil),           // 48: hippocampus.v1.SummariseMemoriesRequest
	(*SummariseMemoriesResponse)(nil),          // 49: hippocampus.v1.SummariseMemoriesResponse
	(*ArchiveHeader)(nil),                      // 50: hippocampus.v1.ArchiveHeader
	...
	(*WhoAmIResponse)(nil),                     // 90: hippocampus.v1.WhoAmIResponse
	(*TopologyAttribute)(nil),                  // 91: hippocampus.v1.TopologyAttribute
	(*TopologyNode)(nil),                       // 92: hippocampus.v1.TopologyNode
	(*TopologyEdge)(nil),                       // 93: hippocampus.v1.TopologyEdge
	(*GetTopologyResponse)(nil),                // 94: hippocampus.v1.GetTopologyResponse
	(*EmptyRequest)(nil),                       // 95: hippocampus.v1.EmptyRequest
	nil,                                        // 96: hippocampus.v1.Event.MetadataEntry
	nil,                                        // 97: hippocampus.v1.Memory.MetadataEntry
}
var file_hippocampus_proto_depIdxs = []int32{
	...
	96,  // 4: hippocampus.v1.Event.metadata:type_name -> hippocampus.v1.Event.MetadataEntry
	...
	97,  // 8: hippocampus.v1.Memory.metadata:type_name -> hippocampus.v1.Memory.MetadataEntry
	...
	0,   // 13: hippocampus.v1.GetEventsRequest.ended:type_name -> hippocampus.v1.Bool
	15,  // 14: hippocampus.v1.GetEventsResponse.events:type_name -> hippocampus.v1.Event
	1,   // 15: hippocampus.v1.GetMemoriesRequest.significance_extremum:type_name -> hippocampus.v1.SignificanceExtremum
	0,   // 16: hippocampus.v1.GetMemoriesRequest.recalled:type_name -> hippocampus.v1.Bool
	0,   // 17: hippocampus.v1.GetMemoriesRequest.is_summary:type_name -> hippocampus.v1.Bool
	0,   // 18: hippocampus.v1.GetMemoriesRequest.is_binary:type_name -> hippocampus.v1.Bool
	0,   // 19: hippocampus.v1.GetMemoriesRequest.has_event:type_name -> hippocampus.v1.Bool
	2,   // 20: hippocampus.v1.GetMemoriesRequest.order_dir:type_name -> hippocampus.v1.SortDirection
	17,  // 21: hippocampus.v1.GetMemoriesResponse.memories:type_name -> hippocampus.v1.Memory
	17,  // 22: hippocampus.v1.StoreMemoriesRequest.memories:type_name -> hippocampus.v1.Memory
	31,  // 23: hippocampus.v1.StoreMemoriesResponse.results:type_name -> hippocampus.v1.StoreMemoryResult
	3,   // 24: hippocampus.v1.SearchMemoriesRequest.mode:type_name -> hippocampus.v1.SearchMode
	16,  // 25: hippocampus.v1.LinkMemoriesRequest.links:type_name -> hippocampus.v1.Link
	4,   // 26: hippocampus.v1.GetMemoryLinksRequest.direction:type_name -> hippocampus.v1.LinkDirection
	16,  // 27: hippocampus.v1.LinkEventsRequest.links:type_name -> hippocampus.v1.Link
	4,   // 28: hippocampus.v1.GetEventLinksRequest.direction:type_name -> hippocampus.v1.LinkDirection
	4,   // 29: hippocampus.v1.LinkEdge.direction:type_name -> hippocampus.v1.LinkDirection
	42,  // 30: hippocampus.v1.GetLinksResponse.links:type_name -> hippocampus.v1.LinkEdge
	17,  // 31: hippocampus.v1.ReplaceMemoriesWithSummaryRequest.summary:type_name -> hippocampus.v1.Memory
	46,  // 32: hippocampus.v1.GetSummarisationCandidatesResponse.candidates:type_name -> hippocampus.v1.SummarisationCandidate
	12,  // 33: hippocampus.v1.SummariseMemoriesRequest.placement:type_name -> hippocampus.v1.SignificancePlacement
	50,  // 34: hippocampus.v1.ArchiveRecord.header:type_name -> hippocampus.v1.ArchiveHeader
	15,  // 35: hippocampus.v1.ArchiveRecord.event:type_name -> hippocampus.v1.Event
	...
	88,  // 61: hippocampus.v1.AncillaryStorage.forgotten_log:type_name -> hippocampus.v1.AncillaryTable
	88,  // 62: hippocampus.v1.AncillaryStorage.search_outbox:type_name -> hippocampus.v1.AncillaryTable
	88,  // 63: hippocampus.v1.AncillaryStorage.callback_queue:type_name -> hippocampus.v1.AncillaryTable
	3,   // 64: hippocampus.v1.WhoAmIResponse.search_modes:type_name -> hippocampus.v1.SearchMode
	8,   // 65: hippocampus.v1.TopologyNode.kind:type_name -> hippocampus.v1.TopologyNodeKind
	9,   // 66: hippocampus.v1.TopologyNode.source:type_name -> hippocampus.v1.TopologyNodeSource
	10,  // 67: hippocampus.v1.TopologyNode.status:type_name -> hippocampus.v1.TopologyStatus
	91,  // 68: hippocampus.v1.TopologyNode.attributes:type_name -> hippocampus.v1.TopologyAttribute
	92,  // 69: hippocampus.v1.GetTopologyResponse.nodes:type_name -> hippocampus.v1.TopologyNode
	93,  // 70: hippocampus.v1.GetTopologyResponse.edges:type_name -> hippocampus.v1.TopologyEdge
	95,  // 71: hippocampus.v1.Hippocampus.Purge:input_type -> hippocampus.v1.EmptyRequest
	95,  // 72: hippocampus.v1.Hippocampus.Sleep:input_type -> hippocampus.v1.EmptyRequest
	67,  // 73: hippocampus.v1.Hippocampus.PreviewConsolidation:input_type -> hippocampus.v1.PreviewConsolidationRequest
	84,  // 74: hippocampus.v1.Hippocampus.ExplainConsolidation:input_type -> hippocampus.v1.ExplainConsolidationRequest
	95,  // 75: hippocampus.v1.Hippocampus.GetConsolidationStatus:input_type -> hippocampus.v1.EmptyRequest
	71,  // 76: hippocampus.v1.Hippocampus.GetForgottenMemories:input_type -> hippocampus.v1.GetForgottenMemoriesRequest
	73,  // 77: hippocampus.v1.Hippocampus.DeleteForgottenMemories:input_type -> hippocampus.v1.DeleteForgottenMemoriesRequest
	76,  // 78: hippocampus.v1.Hippocampus.GetCallbackQueue:input_type -> hippocampus.v1.GetCallbackQueueRequest
	78,  // 79: hippocampus.v1.Hippocampus.DeleteCallbackQueue:input_type -> hippocampus.v1.DeleteCallbackQueueRequest
	95,  // 80: hippocampus.v1.Hippocampus.WhoAmI:input_type -> hippocampus.v1.EmptyRequest
	95,  // 81: hippocampus.v1.Hippocampus.GetTopology:input_type -> hippocampus.v1.EmptyRequest
	13,  // 82: hippocampus.v1.Hippocampus.GetSignificanceLevels:input_type -> hippocampus.v1.GetSignificanceLevelsRequest
	15,  // 83: hippocampus.v1.Hippocampus.StoreEvent:input_type -> hippocampus.v1.Event
	15,  // 84: hippocampus.v1.Hippocampus.UpdateEvent:input_type -> hippocampus.v1.Event
	19,  // 85: hippocampus.v1.Hippocampus.EndEvent:input_type -> hippocampus.v1.EndEventRequest
	20,  // 86: hippocampus.v1.Hippocampus.UpdateEventSignificance:input_type -> hippocampus.v1.UpdateEventSignificanceRequest
	21,  // 87: hippocampus.v1.Hippocampus.MergeEvents:input_type -> hippocampus.v1.MergeEventsRequest
	22,  // 88: hippocampus.v1.Hippocampus.DeleteEvent:input_type -> hippocampus.v1.DeleteEventRequest
	23,  // 89: hippocampus.v1.Hippocampus.GetEventById:input_type -> hippocampus.v1.GetEventByIdRequest
	25,  // 90: hippocampus.v1.Hippocampus.GetEvents:input_type -> hippocampus.v1.GetEventsRequest
	17,  // 91: hippocampus.v1.Hippocampus.StoreMemory:input_type -> hippocampus.v1.Memory
	30,  // 92: hippocampus.v1.Hippocampus.StoreMemories:input_type -> hippocampus.v1.StoreMemoriesRequest
	17,  // 93: hippocampus.v1.Hippocampus.UpdateMemory:input_type -> hippocampus.v1.Memory
	33,  // 94: hippocampus.v1.Hippocampus.DeleteMemories:input_type -> hippocampus.v1.DeleteMemoriesRequest
	27,  // 95: hippocampus.v1.Hippocampus.GetMemories:input_type -> hippocampus.v1.GetMemoriesRequest
	34,  // 96: hippocampus.v1.Hippocampus.RecallMemories:input_type -> hippocampus.v1.RecallMemoriesRequest
	35,  // 97: hippocampus.v1.Hippocampus.SearchMemories:input_type -> hippocampus.v1.SearchMemoriesRequest
	36,  // 98: hippocampus.v1.Hippocampus.LinkMemories:input_type -> hippocampus.v1.LinkMemoriesRequest
	37,  // 99: hippocampus.v1.Hippocampus.UnlinkMemories:input_type -> hippocampus.v1.UnlinkMemoriesRequest
	38,  // 100: hippocampus.v1.Hippocampus.GetMemoryLinks:input_type -> hippocampus.v1.GetMemoryLinksRequest
	39,  // 101: hippocampus.v1.Hippocampus.LinkEvents:input_type -> hippocampus.v1.LinkEventsRequest
	40,  // 102: hippocampus.v1.Hippocampus.UnlinkEvents:input_type -> hippocampus.v1.UnlinkEventsRequest
	41,  // 103: hippocampus.v1.Hippocampus.GetEventLinks:input_type -> hippocampus.v1.GetEventLinksRequest
	44,  // 104: hippocampus.v1.Hippocampus.ReplaceMemoriesWithSummary:input_type -> hippocampus.v1.ReplaceMemoriesWithSummaryRequest
	95,  // 105: hippocampus.v1.Hippocampus.GetSummarisationCandidates:input_type -> hippocampus.v1.EmptyRequest
	48,  // 106: hippocampus.v1.Hippocampus.SummariseMemories:input_type -> hippocampus.v1.SummariseMemoriesRequest
	54,  // 107: hippocampus.v1.Hippocampus.Export:input_type -> hippocampus.v1.ExportRequest
	56,  // 108: hippocampus.v1.Hippocampus.Import:input_type -> hippocampus.v1.ImportRequest
	52,  // 109: hippocampus.v1.Hippocampus.ImportBatch:input_type -> hippocampus.v1.ImportBatchRequest
	58,  // 110: hippocampus.v1.Hippocampus.Transfer:input_type -> hippocampus.v1.TransferRequest
	60,  // 111: hippocampus.v1.Hippocampus.Clear:input_type -> hippocampus.v1.ClearRequest
	62,  // 112: hippocampus.v1.Hippocampus.DeleteMemoriesByFilter:input_type -> hippocampus.v1.DeleteMemoriesByFilterRequest
	64,  // 113: hippocampus.v1.Hippocampus.DeleteEventsByFilter:input_type -> hippocampus.v1.DeleteEventsByFilterRequest
	66,  // 114: hippocampus.v1.Hippocampus.Purge:output_type -> hippocampus.v1.GeneralResponse
	66,  // 115: hippocampus.v1.Hippocampus.Sleep:output_type -> hippocampus.v1.GeneralResponse
	69,  // 116: hippocampus.v1.Hippocampus.PreviewConsolidation:output_type -> hippocampus.v1.PreviewConsolidationResponse
	85,  // 117: hippocampus.v1.Hippocampus.ExplainConsolidation:output_type -> hippocampus.v1.ExplainConsolidationResponse
	87,  // 118: hippocampus.v1.Hippocampus.GetConsolidationStatus:output_type -> hippocampus.v1.GetConsolidationStatusResponse
	72,  // 119: hippocampus.v1.Hippocampus.GetForgottenMemories:output_type -> hippocampus.v1.GetForgottenMemoriesResponse
	74,  // 120: hippocampus.v1.Hippocampus.DeleteForgottenMemories:output_type -> hippocampus.v1.DeleteForgottenMemoriesResponse
	77,  // 121: hippocampus.v1.Hippocampus.GetCallbackQueue:output_type -> hippocampus.v1.GetCallbackQueueResponse
	79,  // 122: hippocampus.v1.Hippocampus.DeleteCallbackQueue:output_type -> hippocampus.v1.DeleteCallbackQueueResponse
	90,  // 123: hippocampus.v1.Hippocampus.WhoAmI:output_type -> hippocampus.v1.WhoAmIResponse
	94,  // 124: hippocampus.v1.Hippocampus.GetTopology:output_type -> hippocampus.v1.GetTopologyResponse
	14,  // 125: hippocampus.v1.Hippocampus.GetSignificanceLevels:output_type -> hippocampus.v1.GetSignificanceLevelsResponse
	18,  // 126: hippocampus.v1.Hippocampus.StoreEvent:output_type -> hippocampus.v1.StoreEventResponse
	66,  // 127: hippocampus.v1.Hippocampus.UpdateEvent:output_type -> hippocampus.v1.GeneralResponse
	66,  // 128: hippocampus.v1.Hippocampus.EndEvent:output_type -> hippocampus.v1.GeneralResponse
	66,  // 129: hippocampus.v1.Hippocampus.UpdateEventSignificance:output_type -> hippocampus.v1.GeneralResponse
	66,  // 130: hippocampus.v1.Hippocampus.MergeEvents:output_type -> hippocampus.v1.GeneralResponse
	66,  // 131: hippocampus.v1.Hippocampus.DeleteEvent:output_type -> hippocampus.v1.GeneralResponse
	24,  // 132: hippocampus.v1.Hippocampus.GetEventById:output_type -> hippocampus.v1.GetEventResponse
	26,  // 133: hippocampus.v1.Hippocampus.GetEvents:output_type -> hippocampus.v1.GetEventsResponse
	29,  // 134: hippocampus.v1.Hippocampus.StoreMemory:output_type -> hippocampus.v1.StoreMemoryResponse
	32,  // 135: hippocampus.v1.Hippocampus.StoreMemories:output_type -> hippocampus.v1.StoreMemoriesResponse
	66,  // 136: hippocampus.v1.Hippocampus.UpdateMemory:output_type -> hippocampus.v1.GeneralResponse
	66,  // 137: hippocampus.v1.Hippocampus.DeleteMemories:output_type -> hippocampus.v1.GeneralResponse
	28,  // 138: hippocampus.v1.Hippocampus.GetMemories:output_type -> hippocampus.v1.GetMemoriesResponse
	28,  // 139: hippocampus.v1.Hippocampus.RecallMemories:output_type -> hippocampus.v1.GetMemoriesResponse
	28,  // 140: hippocampus.v1.Hippocampus.SearchMemories:output_type -> hippocampus.v1.GetMemoriesResponse
	66,  // 141: hippocampus.v1.Hippocampus.LinkMemories:output_type -> hippocampus.v1.GeneralResponse
	66,  // 142: hippocampus.v1.Hippocampus.UnlinkMemories:output_type -> hippocampus.v1.GeneralResponse
	43,  // 143: hippocampus.v1.Hippocampus.GetMemoryLinks:output_type -> hippocampus.v1.GetLinksResponse
	66,  // 144: hippocampus.v1.Hippocampus.LinkEvents:output_type -> hippocampus.v1.GeneralResponse
	66,  // 145: hippocampus.v1.Hippocampus.UnlinkEvents:output_type -> hippocampus.v1.GeneralResponse
	43,  // 146: hippocampus.v1.Hippocampus.GetEventLinks:output_type -> hippocampus.v1.GetLinksResponse
	45,  // 147: hippocampus.v1.Hippocampus.ReplaceMemoriesWithSummary:output_type -> hippocampus.v1.ReplaceMemoriesWithSummaryResponse
	47,  // 148: hippocampus.v1.Hippocampus.GetSummarisationCandidates:output_type -> hippocampus.v1.GetSummarisationCandidatesResponse
	49,  // 149: hippocampus.v1.Hippocampus.SummariseMemories:output_type -> hippocampus.v1.SummariseMemoriesResponse
	55,  // 150: hippocampus.v1.Hippocampus.Export:output_type -> hippocampus.v1.ExportResponse
	57,  // 151: hippocampus.v1.Hippocampus.Import:output_type -> hippocampus.v1.ImportResponse
	53,  // 152: hippocampus.v1.Hippocampus.ImportBatch:output_type -> hippocampus.v1.ImportBatchResponse
	59,  // 153: hippocampus.v1.Hippocampus.Transfer:output_type -> hippocampus.v1.TransferResponse
	61,  // 154: hippocampus.v1.Hippocampus.Clear:output_type -> hippocampus.v1.ClearResponse
	63,  // 155: hippocampus.v1.Hippocampus.DeleteMemoriesByFilter:output_type -> hippocampus.v1.DeleteMemoriesByFilterResponse
	65,  // 156: hippocampus.v1.Hippocampus.DeleteEventsByFilter:output_type -> hippocampus.v1.DeleteEventsByFilterResponse
...
func file_hippocampus_proto_init() {
	...
	file_hippocampus_proto_msgTypes[39].OneofWrappers = []any{
